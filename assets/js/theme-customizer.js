...
( function( $ ) {
	...
	// Dark Mode
	wp.customize( 'atorta_dark_mode', function( value ) {
		value.bind( function( newval ) {
			if ( newval == true ) {
	...
	// Alt Nav
	wp.customize( 'atorta_alt_nav', function( value ) {
		value.bind( function( newval ) {
			console.log( newval );
			if ( newval == true ) {
	...
	// Three grid columns
	wp.customize( 'atorta_max_columns', function( value ) {
		value.bind( function( newval ) {
			if ( newval == true ) {
	...
	// Show preview titles
	wp.customize( 'atorta_show_titles', function( value ) {
		value.bind( function( newval ) {
			if ( newval == true ) {
